...
class QueryAndGroup(nn.Module):
    ...
    def forward(self, xyz: torch.Tensor, new_xyz: torch.Tensor, features: torch.Tensor = None) -> Tuple[torch.Tensor]:
        ...
        # 执行
        xyz1 = xyz*100
        xyz1 = torch.tensor(xyz1, dtype=torch.int16)
        new_xyz1 = new_xyz*100
        new_xyz1 = torch.tensor(new_xyz1, dtype=torch.int16)

        idx = ball_query(self.radius*100, self.nsample, xyz1, new_xyz1)
